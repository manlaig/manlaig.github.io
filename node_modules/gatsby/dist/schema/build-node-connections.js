...
const _require6 = require(`../redux/actions/add-page-dependency`),
      createPageDependency = _require6.createPageDependency;

const _require7 = require(`graphql-skip-limit`),
      connectionFromArray = _require7.connectionFromArray;

function handleQueryResult({
  results,
  resolveArgs: queryArgs,
  path
}) {
