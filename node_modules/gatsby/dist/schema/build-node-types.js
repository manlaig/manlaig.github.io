...
const _require8 = require(`./data-tree-utils`),
      getExampleValues = _require8.getExampleValues,
      clearTypeExampleValues = _require8.clearTypeExampleValues;

const _require9 = require(`../db/nodes-query`),
      runQuery = _require9.run;
...
function buildProcessedType(_x3) {
  return _buildProcessedType.apply(this, arguments);
}

function _buildProcessedType() {
  _buildProcessedType = (0, _asyncToGenerator2.default)(function* ({
    nodes,
    typeName,
    processedTypes,
    span
...
function _buildAll() {
  _buildAll = (0, _asyncToGenerator2.default)(function* ({
    ...
    /*#__PURE__*/
    function () {
      var _ref2 = (0, _asyncToGenerator2.default)(function* (nodes, typeName) {
        const fieldName = _.camelCase(typeName);

        const processedType = yield buildProcessedType({
          nodes,
          typeName,
          processedTypes,
          span
