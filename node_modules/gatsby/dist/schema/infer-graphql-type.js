...
const _require5 = require(`../redux/actions/add-page-dependency`),
...
const _require6 = require(`./data-tree-utils`),
      getExampleValues = _require6.getExampleValues,
      isEmptyObjectOrArray = _require6.isEmptyObjectOrArray,
      INVALID_VALUE = _require6.INVALID_VALUE;
...
function inferFromMapping(value, mapping, fieldSelector, types) {
  ...
  const findNode = (fieldValue, path) => {
    const linkedNode = _.find(getNodesByType(linkedType), n => _.get(n, linkedField) === fieldValue);
