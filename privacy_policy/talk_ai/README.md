...
- Access your device's microphone and speech recognition capabilities to provide text-to-speech features for communication

We use this information to provide features of our app, to improve and customize our app. The information is not uploaded to the Company's servers and/or a Service Provider's server, it will be simply stored on Your device.
...
There is a link within the app that directs you to [this](https://forms.gle/y4B7R2nmDbFHyduv8) form, which you can fill to request data deletion. The completion time for data deletion is around 24-48 hours.
Or you can press in this link to access it:
https://forms.gle/y4B7R2nmDbFHyduv8
